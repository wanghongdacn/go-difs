...
go-pkg-name=$(shell $(GOCC) list $(go-tags) github.com/Harold-the-Axeman/dacc-iam-filesystem/$(1))
go-main-name=$(notdir $(call go-pkg-name,$(1)))$(?exe)
go-curr-pkg-tgt=$(d)/$(call go-main-name,$(d))
go-pkgs-novendor=$(shell $(GOCC) list github.com/Harold-the-Axeman/dacc-iam-filesystem/... | grep -v /Godeps/)
...
check_go_path:
	GOPATH="$(GOPATH)" bin/check_go_path github.com/Harold-the-Axeman/dacc-iam-filesystem
.PHONY: check_go_path
