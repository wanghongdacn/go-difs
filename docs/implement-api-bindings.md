...
Currently, the [go-ipfs](https://github.com/Harold-the-Axeman/dacc-iam-filesystem) implementation supports
...
(as of [this PR](https://github.com/Harold-the-Axeman/dacc-iam-filesystem/pull/1598), or `0.3.8`):
