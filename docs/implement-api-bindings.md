...
Currently, the [go-ipfs](https://github.com/daccproject/go-difs) implementation supports
...
(as of [this PR](https://github.com/daccproject/go-difs/pull/1598), or `0.3.8`):
