...
As of writing, [7 hash functions](https://github.com/Harold-the-Axeman/dacc-iam-filesystem-blockstore/blob/547442836ade055cc114b562a3cc193d4e57c884/caching.go#L22) are used, so the constant `k` is 7 in the formula.
...
See [this issue](https://github.com/Harold-the-Axeman/dacc-iam-filesystem/issues/1226#issuecomment-120494604) for more
information.
